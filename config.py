...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql://root:mysql@192.168.142.132:3306/iHome'
    SQLALCHEMY_TRACK_MODIFICATIONS = False

    # 配置redis数据库：开发中使用真实IP
    REDIS_HOST = '192.168.142.132'
    REDIS_PORT = 6379
...
class ProductionConfig(Config):
    ...
    # 重写有差异性的配置
    SQLALCHEMY_DATABASE_URI = 'mysql://root:mysql@192.168.142.132:3306/iHome_product_test'
...
class UnittestConfig(Config):
    ...
    # 重写有差异性的配置
    SQLALCHEMY_DATABASE_URI = 'mysql://root:mysql@192.168.142:3306/iHome_unittest_test'
